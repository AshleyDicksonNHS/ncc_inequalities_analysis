...
# Create gestation categories
data_gest <- data %>%
  filter(!is.na(Gestation_Length_At_Birth)) %>%
  mutate(
    Gestation_Group = case_when(
      Gestation_Length_At_Birth < 28 ~ "Extremely preterm (<28 weeks)",
      Gestation_Length_At_Birth < 32 ~ "Very preterm (28-31 weeks)",
      Gestation_Length_At_Birth < 37 ~ "Moderate/Late preterm (32-36 weeks)",
      Gestation_Length_At_Birth <= 42 ~ "Term (37-42 weeks)",
